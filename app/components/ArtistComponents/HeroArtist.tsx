...
const HeroArtist = () => {
    ...
    //     { id: 3, title: 'ServicesList', href: '/services' },
                ...
                <div className="container mx-auto px-4 py-12 flex items-center justify-center">
                    <div className="flex flex-col items-center justify-center p-4">
                        ...
                        <div className="text-center max-w-4xl">
                            <h2 className="text-4xl font-semibold text-gray-300 mb-2">Artist</h2>
                            <h3 className="text-lg text-gray-300">Check out the wonderful ministers of the world God has given us...</h3>
                        </div>
                    </div>
                </div>
            </div>
